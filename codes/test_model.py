...
for test_loader in test_loaders:
    ...
    if 1:
        ...
        readNum = 10
        readDir = '/workspace/cpfs-data/ffmpeg_tools/new_model_test/source_LR_IRN_compress'
        #readDir = '/workspace/cpfs-data/ffmpeg_tools/iir_lol_LR'
        saveDir = '/workspace/cpfs-data/ffmpeg_tools/new_model_test/source_LR_IRN_compress_SR'
        
        #readNum = 1010
        #readDir = '/workspace/cpfs-data/datasets/2022-04-18-16_30_15_2022-04-18-21_50_20'
        #saveDir = '/workspace/cpfs-data/datasets/2022-04-18-16_30_15_2022-04-18-21_50_20-L'
        
        #readNum = 1010
        #readDir = '/workspace/cpfs-data/datasets/2022-05-17-19_26_41_2022-05-17-20_23_23_Trim'
        #saveDir = '/workspace/cpfs-data/datasets/2022-05-17-19_26_41_2022-05-17-20_23_23_Trim-L'
        
        #readNum = 2010
        #readDir = '/workspace/cpfs-data/datasets/2022-05-18-06_20_21_2022-05-18-12_20_21'
        #saveDir = '/workspace/cpfs-data/datasets/2022-05-18-06_20_21_2022-05-18-12_20_21-L'
        
        #readNum = 210
        #readDir = '/workspace/cpfs-data/datasets/source_Trim'
        #saveDir = '/workspace/cpfs-data/datasets/source_Trim-L'
        
        #readNum = 1010
        #readDir = '/workspace/cpfs-data/datasets/source0'
        #saveDir = '/workspace/cpfs-data/datasets/source0-L'
        
        #readNum = 210
        #readDir = '/workspace/cpfs-data/datasets/source1'
        #saveDir = '/workspace/cpfs-data/datasets/source1-L'
        
        print('filenumber: {}'.format(readNum))
        print('readDir: {}'.format(readDir))
        print('saveDir: {}'.format(saveDir))
        while True:
            #lrpath = '{}/{}.png'.format(readDir, ("%d" % count))
